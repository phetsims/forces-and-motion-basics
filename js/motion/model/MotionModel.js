...
class MotionModel {
  ...
  constructor( screen, tandem ) {
    ...
    const bucket = new Item( this, 'bucket', tandem.createTandem( 'bucket' ), waterBucket_svg, 100, leftmostItemXRight + manSpacing + trashSpacing + mysterySpacing + bucketSpacing, 547 + -35, 0.64, 1.0, 8 );
    bucket.bucket = true;
