...
addToMapIfDefined( 'a11y_netForceScreen_screenSummary_currentDetails_purpleTeamAttached', 'a11y.netForceScreen.screenSummary.currentDetails.purpleTeamAttachedStringProperty' );
addToMapIfDefined( 'a11y_netForceScreen_screenSummary_currentDetails_orangeTeamAttached', 'a11y.netForceScreen.screenSummary.currentDetails.orangeTeamAttachedStringProperty' );
    ...
    netForceScreen: {
      screenSummary: {
        ...
        currentDetails: {
          ...
          blueTeamAttached: new FluentPattern<{ count: 0 | number | 'one' | number | 'other' | TReadOnlyProperty<0 | number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_netForceScreen_screenSummary_currentDetails_blueTeamAttached', _.get( ForcesAndMotionBasicsStrings, 'a11y.netForceScreen.screenSummary.currentDetails.blueTeamAttachedStringProperty' ), [{"name":"count","variants":[0,{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
          redTeamAttached: new FluentPattern<{ count: 0 | number | 'one' | number | 'other' | TReadOnlyProperty<0 | number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_netForceScreen_screenSummary_currentDetails_redTeamAttached', _.get( ForcesAndMotionBasicsStrings, 'a11y.netForceScreen.screenSummary.currentDetails.redTeamAttachedStringProperty' ), [{"name":"count","variants":[0,{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
          purpleTeamAttached: new FluentPattern<{ count: 0 | number | 'one' | number | 'other' | TReadOnlyProperty<0 | number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_netForceScreen_screenSummary_currentDetails_purpleTeamAttached', _.get( ForcesAndMotionBasicsStrings, 'a11y.netForceScreen.screenSummary.currentDetails.purpleTeamAttachedStringProperty' ), [{"name":"count","variants":[0,{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
          orangeTeamAttached: new FluentPattern<{ count: 0 | number | 'one' | number | 'other' | TReadOnlyProperty<0 | number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_netForceScreen_screenSummary_currentDetails_orangeTeamAttached', _.get( ForcesAndMotionBasicsStrings, 'a11y.netForceScreen.screenSummary.currentDetails.orangeTeamAttachedStringProperty' ), [{"name":"count","variants":[0,{"type":"number","value":"one"},{"type":"number","value":"other"}]}] )
        },
        interactionHint: {
