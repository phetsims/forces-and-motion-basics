...
(5) Open in the browser: `http://localhost/forces-and-motion-basics/forces-and-motion-basics_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/forces-and-motion-basics/build/adapted-from-phet/forces-and-motion-basics_en_adapted-from-phet.html` (You will
